...
Railway Hobby Plan — 8GB RAM, full audio download handled here.

Endpoints:
  GET  /health            — health check
  GET  /info?url=...      — get video metadata
  GET  /extract?url=...   — download and stream audio
"""
...
def get_ytdlp_proxy_args():
    if PROXY_URL:
        return ["--proxy", PROXY_URL, "--socket-timeout", "60", "--retries", "3"]
    return []
